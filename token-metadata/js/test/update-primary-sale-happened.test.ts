...
//     Program metaMoxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s invoke [1]
//     Program log: Instruction: Update primary sale via token
//     Program log: Error: InvalidAccountData
//     Program metaMoxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s consumed 1669 of 200000 compute units
//     Program metaMoxxUerdq28cj1RbAWkYQm3ybzjb6a8bt518x1s failed: invalid account data for instruction
//
